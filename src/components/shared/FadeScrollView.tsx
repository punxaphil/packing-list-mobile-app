...
export const FadeScrollView = forwardRef<
  FadeScrollViewRef,
  FlashScrollViewProps
>(
  (
    { children, style, contentContainerStyle, scrollEnabled = true, onScroll },
    ref,
  ) => {
    ...
    const isScrollable =
      containerHeight > 0 && contentHeight > containerHeight + SCROLL_THRESHOLD;
