...
export const entityStyles = StyleSheet.create({
  ...
  card: { backgroundColor: homeColors.cardBg, borderRadius: 12, paddingHorizontal: homeSpacing.md, paddingVertical: homeSpacing.sm, borderWidth: 1, borderColor: homeColors.border },
  ...
  menuButton: { paddingHorizontal: homeSpacing.md, paddingVertical: homeSpacing.md, marginVertical: -homeSpacing.sm, marginRight: -homeSpacing.sm },
