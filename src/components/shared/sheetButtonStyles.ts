...
export const sheetButtonStyles = StyleSheet.create({
  ...
  filledPrimary: { backgroundColor: homeColors.primary },
  ...
  text: { fontSize: 14, fontWeight: "600", color: homeColors.primary, textAlign: "center" },
  textPrimary: { fontSize: 16, fontWeight: "600", color: homeColors.buttonText, textAlign: "center" },
