...
export const TextPromptDialog = ({ visible, title, confirmLabel, value, placeholder, onChange, onCancel, onSubmit }: TextPromptDialogProps) => (
    <Modal transparent animationType="fade" visible={visible} onRequestClose={onCancel}>
        <Pressable style={homeStyles.modalBackdrop} onPress={onCancel}>
            <Pressable style={homeStyles.modalCard} onPress={(event) => event.stopPropagation()}>
                ...
                <TextInput value={value} onChangeText={onChange} onSubmitEditing={onSubmit} placeholder={placeholder} style={homeStyles.modalInput} autoFocus accessibilityLabel={title} />
