...
export const filterSheetStyles = StyleSheet.create({
  ...
  toggleContainer: { flexDirection: "row", backgroundColor: homeColors.border, borderRadius: 20, padding: 3, marginBottom: homeSpacing.sm },
  toggleOption: { flex: 1, paddingVertical: homeSpacing.sm, alignItems: "center", borderRadius: 17 },
  toggleOptionSelected: { backgroundColor: homeColors.surface, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.15, shadowRadius: 2, elevation: 2 },
