...
const HeaderRow = ({ displayName, email, selection, renameDialog, onProfile }: ItemsPanelProps) => (
    <HomeHeader title={displayName} email={email} onBack={selection.clear} onPressTitle={renameDialog.open} onProfile={onProfile} />
);
